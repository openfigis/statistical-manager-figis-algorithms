...
public class SpatialReallocationSimplifiedAlgorithmTest {
	...
	public void setup() throws Exception{
		...
		config.setAgent("FIGIS_SPATIAL_REALLOCATION_SIMPLIFIED");
		...
		config.setParam("InputIntersection", "FAO_AREAS_x_EEZ_HIGHSEAS");
		config.setParam("IncludeCalculations", "false");
